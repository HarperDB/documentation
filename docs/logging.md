...
and the Leaf server is responsible for managing the message stores (streams) that replicates and store messages between instances. Due to the verbosity of these servers logs there is a separate
